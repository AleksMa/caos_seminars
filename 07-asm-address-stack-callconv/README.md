...
Появится файлик main.s

Оптимизация `g++ -S -O3 main.cpp`
...
`g++ prog.S simpleio_x64_64.S -o prog`
...
`g++ -g prog.S simpleio_x64_64.S -o prog`
...
4. https://github.com/lll-phill-lll/hse_caos_practice
